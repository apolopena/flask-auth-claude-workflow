...
Present the created PLANNING.md content to the user and:
1. Summarize what was extracted (X goals, Y constraints, Z work packages)
2. Highlight any ambiguities or assumptions made
3. Inform them they can now run `/generate-prp .ai/planning/prd/PLANNING.md`
